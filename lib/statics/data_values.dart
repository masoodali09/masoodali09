class DataValues {
  // About App
  static const String appName = 'Masood Ali';
  static const String appNameLong = 'masoodali09';
  static const String appDescription =
      'Hello there, I\'m Masood Ali. This is my personal website, which contains public information that anyone can find on the internet.';
  static const String appDeveloper = 'Masood Ali';
  ...
  static Uri githubURL = Uri.parse('https://github.com/masoodali09');
  static Uri linkedinURL = Uri.parse('https://www.linkedin.com/in/masoodali09/');
  static Uri softthrive = Uri.parse('https://www.softthrive.com/');
  static Uri fiverr = Uri.parse('https://www.fiverr.com/users/masooddev1/seller_dashboard');
  static Uri whatsappURL = Uri.parse('https://wa.me/923106044780?text=Let\'s%20Work%20Together');
  static Uri youtubeURL = Uri.parse('https://youtube.com/@flutterscope');
  static Uri telegramURL = Uri.parse('https://t.me/dileepabandara');
  static Uri facebookURL = Uri.parse('https://www.facebook.com/profile.php?id=100016285653797');
  static Uri instagramURL = Uri.parse('https://www.instagram.com/masoodali09/');
  static Uri repoURL =
  ...
  static const String headerName = 'Masood Ali';
  static const String headerTitle = 'Flutter |  Artificial Intelligence | Machine Learning\n | UI/UX | Django';
  ...
  static const String aboutMeBiographyDescription =
      'Hi there! I\'m a computer Science student and solution developer. I firmly believe that personal growth and continuous learning are essential for success, and I\'ve committed myself to both.'
  'This drive to learn and improve is what fuels my passion for technology and its potential to create positive change. It\'s the reason I embarked on a career as a techie, always eager to explore new concepts and apply them in my work.'
  'I\'m excited to continue growing my skills and knowledge, as I believe that staying curious and adaptable is key to thriving in the ever-evolving tech landscape.';
  static const String aboutMeFullNameTitle = ' Name';
  static const String aboutMeFullNameDescription =
      'Masood Ali';
  static const String aboutMeNwITitle = 'Father Name';
  static const String aboutMeNwIDescription = 'Munawar Ali Khan';
  ...
  static const String aboutMeDobDescription = 'Nov 19, 2002';
  ...
  static const String aboutMeBannerTitle = 'profile';
  ...
  static const String educationOrg1Title = 'NFC Institute of Engineering and Technology';
  static const String educationOrg1Course1Name = 'BSc (Hons) Computer Science';
  ...
  static const String educationOrg2Title = 'Punjab Group of Collages Multan';
  static const String educationOrg2Course1Name = 'ICS(Intermediate of Computer Science)';
  static const String educationOrg2Course1Grade =
      '1st Division';
  static const String educationOrg2Course1Year = '2018 - 2020';
  ...
  static const String experienceOrg1Title = 'SOSTTHRIVE';
  static const String experienceOrg1Role = 'Jr Flutter Developer';
  static const String experienceOrg1Years = 'Oct 2023 - Present';
  static const String experienceOrg1Vales =
      'Android, Flutter, Dart, Firebase, Git, REST API, JSON Parsing & UI UX Designing.';
  static const String experienceOrg2Title = 'SoftThrive';
  static const String experienceOrg2Role =
      'Jr Software Developer (Flutter)';
  static const String experienceOrg2Years = 'Oct 2023 - present';
  ...
  static const String contactEmail = 'masooodali335@gmail.com';

  // Footer
  static const String copyright =
      "Copyright ©2024 Masood ALi. All Rights Reserved.";
